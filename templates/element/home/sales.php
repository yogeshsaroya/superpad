                ...
                <div class="col-xl-4 col-lg-4 col-sm-6">
                    <div class="card card-full">
                        <a href="product-details-v1.html" class="card-image">
                            ...
                            <img src="<?php echo SITEURL; ?>images/thumb/nft-2.jpg" class="card-img-top" alt="art image">
                        </a>
                        <div class="card-body p-4">
                            <div class="logoWrap">
                                <img src="<?php echo SITEURL; ?>img/tether.svg" alt="" />
                            </div>
                            <h5 class="card-title text-truncate mb-0">
                                <p class="mb-0">
                                    <a href="product-details-v1.html">Mecha Morphing</a>
                                    <span>$MAPE</span>
                                </p>
