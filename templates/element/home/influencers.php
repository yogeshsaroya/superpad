                        ...
                        <div class="client-logo-item1 text-center partners_logo">
                            <?php if (!empty($list->url)) { ?>
                                <a href="<?php echo $list->url; ?>" title="<?php echo $list->title; ?>" target="_blank">
                                    <img src="<?php echo SITEURL . "cdn/influencers/" . $list->logo; ?>" alt="" class="img-fluid"></a>
                            <?php } else { ?>
                                <img src="<?php echo SITEURL . "cdn/influencers/" . $list->logo; ?>" alt="" class="img-fluid">
                            <?php } ?>
