     ...
     <ul class="nav navbar-nav">
       <li class="nav-item">
         <a class="navbar-brand" href="<?php echo SITEURL; ?>" target="_blank" title="Go to front-end">
           <img src="http://localhost:8888/cake/superpad/cdn/logo/logo.png" height="50px" alt="">
         </a>
       </li>
     </ul>
   </div>
       ...
       <ul class="nav navbar-nav flex-row">
         <li class="nav-item mr-auto">
           <a class="navbar-brand" href="<?php echo SITEURL; ?>page">
             ...
             <h2 class="brand-text mb-0">SuperPAD</h2>
           </a>
         </li>
...
<?php */ ?>
         ...
         <li class="dropdown nav-item <?php echo (isset($pro_menu) && !empty($pro_menu) ? 'active' : null); ?>" data-menu="dropdown"><a class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-toggle="dropdown">Digital Items</a>
           <ul class="dropdown-menu">
             ...
             <li class="<?php echo (isset($menu_act) && $menu_act == 'tiers' ? 'active' : null); ?>"><a class="dropdown-item d-flex align-items-center" href="<?php echo SITEURL; ?>pages/tiers">Tiers</a></li>
           </ul>
         </li>
