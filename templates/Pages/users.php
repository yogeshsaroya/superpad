                                            ...
                                            <tr>
                                                ...
                                                <td><?php
                                                    if ($list->kyc_completed == 0) {
                                                        ...
                                                        echo '<span class="badge rounded-pill bg-warning text-dark">In Review</span>';
                                                    } elseif ($list->kyc_completed == 2) {
                                                        echo '<span class="badge rounded-pill bg-success">Verifid</span>';
                                                    } elseif ($list->kyc_completed == 3) {
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <?php if ($list->kyc_completed != 0) {
                                                                echo $this->Html->link('<i data-feather="edit-2" class="mr-50"></i> KYC ', SITEURL . "pages/manage_kyc/" . $list->id, ['escape' => false, 'class' => 'dropdown-item']);
                                                            } ?>
