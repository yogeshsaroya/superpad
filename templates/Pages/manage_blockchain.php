                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-12 form-group mb-2"><?php echo $this->Form->control('price', ['label' => ['escape' => false, 'text' => 'Coin Price <small>(in USD)</small>'],'class' => 'form-control amt', 'placeholder' => '00.00', 'required' => false]); ?><div class="help-block with-errors"></div></div>
