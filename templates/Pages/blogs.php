        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                <div class="form-group breadcrumb-right">
                    <div class="dropdown">
                        <?php echo $this->Html->link('Add New Post','/pages/manage_blog',['class'=>'btn btn-primary mr-1 waves-effect waves-float waves-light']);?>
                                    ...
                                    if (!empty($data)) {
                                        foreach ($data as $list) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $this->Html->link(SITEURL."blogs/".$list->url,SITEURL."news/".$list->url, ['target' => '_blank']); ?></td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <?php echo $this->Html->link('<i data-feather="edit-2" class="mr-50"></i> Edit',SITEURL . "pages/manage_blog/".$list->id    ,['escape' => false,'class'=>'dropdown-item']); ?>
                                                            <?php echo $this->Html->link('<i data-feather="trash" class="mr-50"></i> Delete',SITEURL . "pages/blogs?del=".$list->id,['escape' => false,'class'=>'dropdown-item', 'onclick' => "return confirm('Are you sure you want to delete this blog post?')"]); ?>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
