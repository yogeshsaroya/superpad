            ...
            <section class="invoice-preview-wrapper">
                <div class="row invoice-preview">
                    ...
                    <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                        <div class="card">
                            <div class="card-body">
                            <?php echo $this->Html->Link('Reject',SITEURL . "pages/manage_kyc/".$get_data->id."?st=3",['escape' => false,'class'=>'btn btn-danger btn-block', 'onclick' => "return confirm('Are you sure you want to Reject this KYC?')"]); ?>
                            <?php echo $this->Html->Link('Approve',SITEURL . "pages/manage_kyc/".$get_data->id."?st=2",['escape' => false,'class'=>'btn btn-success btn-block', 'onclick' => "return confirm('Are you sure you want to Approve this KYC?')"]); ?>
                            <?php echo $this->Html->Link('Back to Users',SITEURL . "pages/users/",['escape' => false,'class'=>'btn btn-default btn-block']); ?>
                            </div>
                        </div>
                    </div>
