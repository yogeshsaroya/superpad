            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Stake</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    ?>
                                    <div class="row">
                                        <div class="col-md-12 col-12 form-group mb-2"><?php echo $this->Form->control('days', ['type' => 'number', 'class' => 'form-control', 'required' => true]); ?><div class="help-block with-errors"></div>
                                        </div>
                                        <div class="col-md-12 col-12 form-group mb-2"><?php echo $this->Form->control('percentage', ['label'=>'APR', 'class' => 'form-control amt numeral-mask', 'placeholder' => '00.00', 'required' => true]); ?><div class="help-block with-errors"></div>
                                        </div>
