<?php $this->assign('title', 'Edit Email Template'); ?>
<!-- BEGIN: Content-->
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Edit Email Template</h2>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php
                                echo $this->Form->create($data, ['autocomplete' => 'off', 'id' => 'e_frm', 'class' => 'mt-2', 'data-toggle' => 'validator']);
                                echo $this->Form->hidden('id');
                                ?>

                                <div class="row">
                                    <div class="col-md-12 col-12 form-group mb-2"><?php echo $this->Form->control('type', ['lable' => 'Email Type', 'class' => 'form-control', 'required' => true]); ?><div class="help-block with-errors"></div>
                                    </div>
