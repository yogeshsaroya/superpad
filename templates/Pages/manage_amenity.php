...
<?php $this->assign('title', 'Add New Amenity');
?>
<!-- BEGIN: Content-->
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Add New Amenity</h2>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-2"><?php echo $this->Form->control('name', ['class' => 'form-control', 'required' => true]); ?><div class="help-block with-errors"></div>
                                        </div>
                                    </div>
